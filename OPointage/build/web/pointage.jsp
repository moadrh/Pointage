<%-- 
    Document   : pointage
    Created on : 12 janv. 2019, 14:56:01
    Author     : dell
--%>
...
<%-- 
    Document   : fonction
    Created on : 12 janv. 2019, 13:37:10
    Author     : dell
--%>
                            ...
                            <div id="demo-form2" data-parsley-validate=""  class="form-horizontal form-label-left" novalidate="">
                                <div class="form-group"  >
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="datetime-local" id="date" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" >
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Etat </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="etat" name="employe" class="form-control form-control-lg" >
                                            <option value="hidden">Choisit un état</option>
                        ...
                        <div class="x_content" >
                            ...
                            <div id="demo-form2" data-parsley-validate=""  class="form-horizontal form-label-left" novalidate="">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Employé </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="employe1" name="role" class="form-control form-control-lg" >
                                            <option value="hidden">Choisit un employé</option>
                                            <% for (Employe e : es.findAll()) {%>
                                            <option value="<%= e.getId()%>" ><%= e.getNom() + ' ' + e.getPrenom()%></option>
                                            <%}%>
                                ...
                                <span id="dates" hidden="true" >
                                    <div class="form-group"  >
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="datetime-local" id="date1" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group"  >
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Date 2 </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="datetime-local" id="date2" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                </span>
                            </div>
                                ...
                                <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">MODIFIER</th>
                                        </tr>
                                    </thead>
                                    <tbody id="mTable">
