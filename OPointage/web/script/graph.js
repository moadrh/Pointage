...
$("#employe").change(() => {
    let employe = $('#employe').val();
    let hidden_chart = document.getElementById("chart");
    if (employe === "hidden") {
        hidden_chart.hidden = true;
        console.log("jch " + employe);
    } else {
        hidden_chart.hidden = false;
        let choix = $("#choix").val();
        if (choix === "annee") {
            $.ajax({
                url: "GrapheController",
...
// @see adapted from http://www.anujgakhar.com/2014/03/01/binary-search-in-javascript/
    ...
    console.log(datas);
//
    let mois = datas.slice(0, 12);
//    let m = JSON.parse(mois);
    console.log(mois);
    let nbrHeures = datas.slice(12, 14);
    let g = JSON.parse(nbrHeures);
    console.log(g);
        ...
        datasets: [
            {
                ...
                pointRadius: 1,
                pointHitRadius: 10,
                data: [12, 78, 78, 95, 12, 12, 65, 35, 0, 0, 11, 42],
            }
        ]
    };
